...
const AboutMe = () => {
    return (
        <div className="grid pb-4 px-8 md:p-16 grid-rows-3 grid-flow-col gap-4 bg-white dark:bg-primaryBg">
            <h1 className="hidden md:flex md:row-span-3">Some Image/Gif</h1>
            <h1 className="col-span-2 place-self-center font-bold text-2xl lg:text-4xl">ABOUT ME</h1>
